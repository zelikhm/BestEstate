    ...
    <header class="header">
        <div class="container header__container">
            ...
            <nav class="nav" id="nav-menu">
                <ul class="nav__list">
                    <li class="nav__item"><a :href="route('main')" class="nav__link" v-bind:class="{ 'nav__link-active': page === 1 }">главная</a></li>
                    <li class="nav__item"><Link :href="route('catalog')" class="nav__link" v-bind:class="{ 'nav__link-active': page === 2 }">каталог</Link></li>
                    <li class="nav__item"><a href="#" class="nav__link" v-bind:class="{ 'nav__link-active': page === 3 }">квартиры</a></li>
            ...
            <div class="nav__btns">
                ...
                <a href="#" class="btn-icon to-state" data-state="login">
