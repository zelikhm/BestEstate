 ...
 *
 * // * @property \App\Models\BuilderModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class BuilderModel extends Section implements Initializable
{
    /**
     * @var bool
     */
...
//            ->setDisplaySearch(true, 'поиск')
        ...
        })->setNewEntryButtonText('Добавить застройщика');
