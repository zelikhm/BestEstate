 ...
 *
 * // * @property \App\Models\Jk\RenderModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class Render extends Section implements Initializable
{
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $title = 'Рендеры для ЖК';
...
//            ->setDisplaySearch(true, 'поиск')
    ...
    public function onEdit($id = null, array $payload = [])
    {
        ...
        $form = AdminForm::elements([
            ...
            AdminFormElement::file('file', 'Рендер'),
        ]);
