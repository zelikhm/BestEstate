 ...
 *
 * // * @property \App\Models\Info\CityModel $model
 *
...
class City extends Section implements Initializable
{
     ...
     * @var string
     */
    protected $title = 'Города\Области';
    ...
    public function onDisplay()
    {
        ...
        $columns = [
            ...
            AdminColumn::text('city_name', 'Город')->setWidth('350px'),
            AdminColumn::text('region_name', 'Область')->setWidth('350px'),
        ];
    ...
    public function onEdit($id = null, array $payload = [])
    {
        ...
        $form = AdminForm::elements([
            AdminFormElement::text('city_name', 'Название города'),
            AdminFormElement::text('region_name', 'Название области'),
        ]);
