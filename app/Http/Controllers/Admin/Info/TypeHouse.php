 ...
 *
 * // * @property \App\Models\Info\TypeHouseModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class TypeHouse extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    {
        $page = AdminNavigation::getPages()->findById('characteristic');

        $page->addPage(
            $this->makePage(700)->setIcon('fas fa-user-lock')
        );
    }
    ...
    public function onDisplay()
    {
        ...
        })->setNewEntryButtonText('Добавить тип Здания');
