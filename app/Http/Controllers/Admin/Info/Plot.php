 ...
 *
 * // * @property \App\Models\Info\PlotModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class Plot extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    public function onDisplay()
    {
        ...
        })->setNewEntryButtonText('Добавить тип Участка');
