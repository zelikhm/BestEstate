 ...
 *
 * // * @property \App\Models\Info\TypeComModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class TypeCom extends Section implements Initializable
{
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $title = 'Тип коммерческого';
    ...
    public function onDisplay()
    {
        ...
        })->setNewEntryButtonText('Добавить тип Ком.здания');
