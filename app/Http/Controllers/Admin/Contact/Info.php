 ...
 *
 * // * @property \App\Models\Contact\InfoModel $model
 *
 * @see https://sleepingowladmin.ru/#/ru/model_configuration_section
 */
class Info extends Section implements Initializable
{
    /**
     * @var bool
     */
    ...
    public function onDisplay()
    {
        ...
        $columns = [
            ...
            AdminColumn::text('name', 'Реквизит')->setWidth('350px'),
        ];
...
//            ->setDisplaySearch(true, 'поиск')
    ...
    public function onEdit($id = null, array $payload = [])
    {
        ...
        $form = AdminForm::elements([
            ...
            AdminFormElement::text('title', 'Название реквизита'),
            AdminFormElement::text('name', 'Реквизит'),
